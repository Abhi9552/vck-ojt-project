...
const HomePage = () => {
    return(
        <div class="body" >
          ...
          <center><img src="images/vck.png" height="300px" width="97%"></img></center> 
      ...
      <ul type="square"></ul>
        ...
        <li>Strong Placements: Excellent career opportunities with leading companies.</li><hr></hr>
        <h2>Campus Life & Facilities</h2>
        <center><img src="images/vck image 1.jpeg" width="450px " height="250px" ></img>
        <img src="images/vck img 2.jpg" width="450px" height="250"></img></center>
